...
class AccountDataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    ...
    /**
     * @param \GLSCroatia\Shipping\Model\ResourceModel\Account\CollectionFactory $collectionFactory
     * @param string $name
    ...
    public function __construct(
        \GLSCroatia\Shipping\Model\ResourceModel\Account\CollectionFactory $collectionFactory,
        string $name,
     ...
     * Return collection.
     *
     * @return \GLSCroatia\Shipping\Model\ResourceModel\Account\Collection
     */
